...
const TermsAndConditions = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 text-gray-700">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold text-gray-800 mb-2">3. Purchases & Payments</h2>
        <p>
      ...
      {/* 4. Returns & Refunds */}
      <section className="mb-6">
        <h2 className="text-xl font-semibold text-gray-800 mb-2">4. Returns & Refunds</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold text-gray-800 mb-2">8. Contact Information</h2>
        <p>
